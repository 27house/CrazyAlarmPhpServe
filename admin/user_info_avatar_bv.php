...
$user_info_avatar_blobview = NULL; // Initialize page object first

class cuser_info_avatar_blobview extends cuser_info {
	...
	// Page object name
	var $PageObjName = 'user_info_avatar_blobview';
...
// Create page object
if (!isset($user_info_avatar_blobview)) $user_info_avatar_blobview = new cuser_info_avatar_blobview();

// Page init
$user_info_avatar_blobview->Page_Init();

// Page main
$user_info_avatar_blobview->Page_Main();
?>
<?php
$user_info_avatar_blobview->Page_Terminate();
?>
