...
define("EW_PROJECT_NAME", "summer", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{BB44000F-AEA7-4717-AEF5-CDDD7A526D64}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '8ssOn65e4jjSFlCW', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/summer.css", TRUE); // Project stylesheet file name
...
// Session names
define("EW_SESSION_STATUS", EW_CONN_DB.EW_PROJECT_NAME . "_status", TRUE); // Login status
...
$EW_LANGUAGE_FILE[] = array("zh-cn", "", "chinese-utf8.xml");
define("EW_LANGUAGE_DEFAULT_ID", "zh-cn", TRUE);
...
define("EW_USER_NAME_FILTER", "(`account` = '%u')",  TRUE);
