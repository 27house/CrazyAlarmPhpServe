...
<script>
	$("ul.breadcrumb").parents("table").remove();
</script>
<link rel="stylesheet" type="text/css" href="zj_login.css?v1.0">
						<div class="login-container">
							<div class="center">
								<h1>
									<i style="display:none;" class="icon-leaf green"></i>
									<span style="display:none;" class="red">3CUC</span>
									<span class="white"><?php echo $Language->ProjectPhrase("BodyTitle") ?></span>
								</h1>
								<h4 style="display:none;"  class="blue" id="com_name_div">&copy; Company Name</h4>
							</div>
...
?>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="username" id="username" class="form-control" placeholder="username" value="<?php echo $login->Username ?>">
															<i class="icon-user"></i>
														</span>
													</label>
													<label class="block clearfix">
													...
													<div class="clearfix">
														<label class="inline">
															<input type="radio" name="type" checked="checked" value="a">
															<span class="lbl" id="lbl"> Remember Me </span>
														</label>
										...
										<div id="forget_user_div" class="toolbar clearfix">
										</div>
									</div>
								</div>
<!-- /login-box -->
